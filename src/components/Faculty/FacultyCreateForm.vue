...
import { Faculty, FacultyCreateRequest } from '@/api/types/organization/Faculty';
...
onMounted(() => {
    if (props.faculty) {
        ...
        data.name = props.faculty.name;
        data.description = props.faculty.description;
        data.department_id = props.faculty.department_id;
